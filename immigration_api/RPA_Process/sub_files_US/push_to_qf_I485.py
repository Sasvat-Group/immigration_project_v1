...
def generate_485(ProjectID, formtype, other_objects):
    ...
    if result:
        ...
        if result.IsSpouseCurrentMemberOfUSArmedForcesOrCoastGuard:
            isspouseinmilitary = 'Yes'
        elif not result.IsSpouseCurrentMemberOfUSArmedForcesOrCoastGuard:
        ...
        inspect_value = '1' if most_recent_entry_rec.IsInspectedAdmitted else '2' if most_recent_entry_rec.IsInspectedParoled else '3' if (most_recent_entry_rec.IsInspectedAdmitted or most_recent_entry_rec.IsInspectedParoled) == False else '0'
        ...
        data_dict = [
            ...
            },
            {
                ...
                "FieldValue": '6' if str(result.UnderlyingImmigrantClassification).__contains__('140') else ''
            },
            {
            ...
            },
            {
                ...
                "FieldValue": (
                        str(result.b_firstname if result.b_firstname is not None else results2.BeneficiaryFirstName) + ' ' + str(
            ...
            },
            {
                ...
                "FieldValue": most_recent_entry_rec.I94ExpirationDate.strftime('%m/%d/%Y') if str(
                    most_recent_entry_rec.I94StatusType).lower() not in ('j1', 'j2', 'f1', 'f2') else 'N/A'
            },
            {
            ...
            },
            {
                ...
                "FieldValue": bit_ans(
                    result.JVisaHomeStayRequirementComplied) if result.HasPreviouslyHeldJVisaStatus else ''
            },
            {
                "FieldName": "1ben.GrantedWaiver",
                "FieldValue": bit_ans(
                    result.JVisaHomeStayRequirementWaiverReceived) if result.HasPreviouslyHeldJVisaStatus else ''
            },
            {
            ...
            data_dict.extend([
                ...
                },
                {
                    ...
                    "FieldValue": change_date(
                        most_recent_entry_rec.I94ExpirationDate) if most_recent_entry_rec.I94ExpirationDate else ''
                },
                {
                    "FieldName": "1ben.I94.IDStatus",
        ...
        if result.IsImmigrantVisaApplicant:
            data_dict.extend([
                ...
                },
                {
                    ...
                    "FieldValue": change_date(
                        result.ImmigrantVisaApplicationDecisionDate) if result.ImmigrantVisaApplicationDecisionDate else ''
                }
            ])
        ...
        if len(l5_res) > 0:
            data_dict.extend([
                ...
                },
                {
                    ...
                    "FieldValue": iff(l5_res[0].PostalZipCode)
                },
                {
        ...
        for addr in l5_res:
            ...
            data_dict.extend([
                ...
                },
                {
                    ...
                    "FieldValue": iff(last_perm_address_abroad.PostalZipCode)
                },
                {
        ...
        if len(l5_emp) > 0:
            data_dict.extend([
                ...
                },
                {
                    ...
                    "FieldValue": iff(l5_emp[0].PostalZipCode)
                },
                {
        ...
        if len(l5_emp) > 1:
            data_dict.extend([
                ...
                },
                {
                    ...
                    "FieldValue": iff(l5_emp[1].PostalZipCode)
                },
                {
        ...
        for i in l5_emp:
            if not US_keyword.search(i.Country):
                ben_all_emp = cursor.execute(
                    f'''select *  from [dbo].[BeneficiaryEmployment] 
                where HireDate is not null and  BeneficiaryID = '{result.BeneficiaryID}'
                    ...
                    if not US_keyword.search(emp.Country):
                        data_dict.extend([
                            ...
                            },
                            {
                                ...
                                "FieldValue": iff(emp.PostalZipCode)
                            },
                            {
        ...
        if len(dependents) > 0:
            ...
            if not US_keyword.search(dependents[0].CitizenshipCountry) and (
                    calculate_age(dependents[0].BirthDate) < 21):
                value = 'Yes'
            else:
                value = 'No'
        ...
        if len(dependents) > 1:
            ...
            if not US_keyword.search(dependents[1].CitizenshipCountry) and (
                    calculate_age(dependents[1].BirthDate) < 21):
                value = 'Yes'
            else:
                value = 'No'
        ...
        if len(dependents) > 2:
            ...
            if not US_keyword.search(dependents[2].CitizenshipCountry) and (
                    calculate_age(dependents[2].BirthDate) < 21):
                value = 'Yes'
            else:
                value = 'No'
                ...
                data_dict.extend([
                    {
                        ...
                        "FieldValue": iff(ben_all_edu[0].DegreeType) + " " + iff(ben_all_edu[0].FieldOfStudy) if len(
                            ben_all_edu) > 0 else ''
                    },
                    {
                        "FieldName": "USIMM82483.txt1.01.1.1",
                        "FieldValue": iff(ben_all_edu[1].DegreeType) + " " + iff(ben_all_edu[1].FieldOfStudy) if len(
                            ben_all_edu) > 1 else ''
                    },
                    {
                        "FieldName": "USIMM82483.txt1.01.1.2",
                        "FieldValue": iff(ben_all_edu[2].DegreeType) + " " + iff(ben_all_edu[2].FieldOfStudy) if len(
                            ben_all_edu) > 2 else ''
                    },
                    {
                        "FieldName": "USIMM82483.txt1.01.1.3",
                        "FieldValue": iff(ben_all_edu[3].DegreeType) + " " + iff(ben_all_edu[3].FieldOfStudy) if len(
                            ben_all_edu) > 3 else ''
                    },
                    {
                        "FieldName": "USIMM82483.txt1.01.1.4",
                        "FieldValue": iff(ben_all_edu[4].DegreeType) + " " + iff(ben_all_edu[4].FieldOfStudy) if len(
                            ben_all_edu) > 4 else ''
                    },
                    {
                        "FieldName": "USIMM82483.txt1.01.1.5",
                        "FieldValue": iff(ben_all_edu[5].DegreeType) + " " + iff(ben_all_edu[5].FieldOfStudy) if len(
                            ben_all_edu) > 5 else ''
                    },
                    {
                        "FieldName": "USIMM82483.txt1.01.1.6",
                        "FieldValue": iff(ben_all_edu[6].DegreeType) + " " + iff(ben_all_edu[6].FieldOfStudy) if len(
                            ben_all_edu) > 6 else ''
                    },
                    {
                        "FieldName": "USIMM82483.txt1.01.1.7",
                        "FieldValue": iff(ben_all_edu[7].DegreeType) + " " + iff(ben_all_edu[7].FieldOfStudy) if len(
                            ben_all_edu) > 7 else ''
                    }
                ])
        ...
        pdf_merge_sequence(data_dict, formtype, result, results2, most_recent_entry_rec,
                           most_recent_notice, parent_dir, iff, change_date, qpdf_merger)
    else:
